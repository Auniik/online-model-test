...
@section('body')
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="mt-0 header-title">Manage Slider</h4>
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered w-100">
                        ...
                        @foreach($sliders as $slider)
                            <tr>
                                <td>{{$i++}}</td>
                                <td><img src="{{asset($slider->image)}}" width="50" height="30"></td>
                                <td>{{$slider->title}}</td>
                                ...
                                <td>
                                    ...
                                    {{--<a href="{{route('delete-slider',['id'=>$slider->id])}}" onclick="alert('Are You Delete This')"><i class="fa fa-trash"></i></a>--}}
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
