                ...
                <div class="card-body">
                    <form action="{{route('team-members.store')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <textarea name="short_message" class="form-control" id="editor" >{{old('short_message')
                                }}</textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <textarea name="message" class="form-control" id="editor" required>{{old('message')
                                }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control" type="text" value="{{old('facebook_link')}}"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control" type="text" value="{{old('twitter_link')}}"
                                       name="twitter_link" >
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control" type="text" value="{{old('instagram_link')}}"
                                       name="instagram_link" >
                            </div>
                        </div>
