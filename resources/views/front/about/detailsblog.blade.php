                    ...
                    <div class="position-relative">
                        ...
                        <div class="row m-0">
                            <div class="col-md-12 mb-1">
                                ...
                                <div class="card">
                                    <div class="row m-0">
                                        <div class="col-md-12 text-justify mt-2"><h5 class="text-justify">{{ $blogs->title }} </h5></div>
                                        <div class="col-md-12 "><img class="rounded" src="{{asset($blogs->image)}}" alt="image" height="400" width="100%"></div>
                                        <div class="col-md-12 text-justify"><p class="text-justify p-1">{{ $blogs->short_description }} </p></div>
                                        <div class="col-md-12 text-justify"><p class="text-justify p-1">{!! $blogs->long_description !!}  </p></div>
                                    </div>
                                </div>
