                            ...
                            <div class="col-lg-10 col-md-9">
                                <div class="row align-items-center">
                                    <div class="col-md-7 text-md-left text-center mt-4 mt-sm-0">
                                        <h3 class="title mb-0">{{auth('participant')->user()->name}}</h3>
                                    </div><!--end col-->
                ...
                <div class="col-lg-12 col-md-12 col-12 mt-4 mt-sm-0 pt-2 pt-sm-0">
                    <div class="ml-lg-3">
                        <div class="border-bottom pb-4">
                            <h5>{{auth('participant')->user()->name}}</h5>
                                        ...
                                        <li>
                                            ...
                                            <div class="overflow-hidden d-block">
                                                ...
                                                <a href="javascript:void(0)"
                                                   class="text-muted">{{auth('participant')->user()->email}}</a>
                                            </div>
                                        </li>
...
{{--                                                <p class="text-muted mb-0">{{auth('participant')->user()->birthday}}</p>--}}
{{--                                            </div>--}}
{{--                                        </li>--}}
